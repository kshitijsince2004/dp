  ...
  return (
    <>
      <div className="flex flex-col md:flex-row gap-3">
        {/* Left: Acts & Sections */}
        <fieldset className="flex-1 border-2 border-[var(--border-color)] rounded-2xl p-3.5 bg-[var(--bg-main)]/20 shadow-sm flex flex-col">
        ...
        <fieldset className="flex-1 border-2 border-[var(--border-color)] rounded-2xl p-3.5 bg-[var(--bg-main)]/20 shadow-sm flex flex-col justify-between">
          <legend className="text-[var(--primary)] text-xs sm:text-sm font-bold px-2.5 uppercase tracking-wide">
