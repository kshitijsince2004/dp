...
const base = "w-full min-h-[44px] bg-white border-2 border-slate-200 text-slate-800 text-sm sm:text-base font-medium px-4 py-2.5 rounded-xl outline-none focus:border-[var(--accent-color)] transition-colors placeholder:text-slate-400 disabled:bg-slate-50 disabled:text-slate-400 disabled:cursor-not-allowed";
