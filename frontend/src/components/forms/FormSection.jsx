              ...
              return visibleFields.map((field, index) => {
                ...
                return (
                  <React.Fragment key={key}>
                    {/* Left label cell */}
                    <div className={`bg-[#dfeaf5] px-4 py-3 text-sm sm:text-base ${isRequired ? 'font-bold' : 'font-medium'} text-[var(--primary)] flex items-center gap-2 min-h-[46px] border-r border-[#c7d8ea]
