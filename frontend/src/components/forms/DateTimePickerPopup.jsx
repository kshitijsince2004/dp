    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-200">
          ...
          <button type="button" onClick={commitAndClose} className="text-[10px] font-bold bg-[var(--accent-color)] hover:bg-[var(--accent-color-hover)] text-white px-3 py-1 rounded cursor-pointer border-none transition-colors shadow-sm font-display">
            Done
          </button>
        </div>
      </div>
