...
export const env = {
  ...
  DATABASE_URL: getEnv('DATABASE_URL', 'postgresql://pharos:pharos@localhost:5435/pharos_db'),
  ...
  // Controllers read process.env.REPORTS_DIR; keep env.js in sync (REPORTS_OUTPUT_DIR was a drift alias).
