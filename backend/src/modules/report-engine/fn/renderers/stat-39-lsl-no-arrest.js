// backend/src/modules/report-engine/fn/renderers/stat-39-lsl-no-arrest.js
// STAT_39: L&SL Cases Chargesheeted without Arrest

import db from '../../../../config/db.js';
import { buildFnDateWindows } from '../../shared/date-windows.js';
import { ACT_HEADS } from '../fn-heads.js';

export async function renderStat39(workbook, scope, calcData = new Date()) {
  ...
  try {
    ...
    console.warn(`[stat-39] Error rendering LSL cases without arrest: ${err.message}`);
  }
}
