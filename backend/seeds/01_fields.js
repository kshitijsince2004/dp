  ...
  { id: 'C_min_gamb',  field_key: 'gambling_minor_head',  field_type: 'TEXT',     applicable_record_types: JSON.stringify(['CASE', 'ARREST','UIDB']), label_en: 'Minor Head (Gambling)',               label_hi: 'लघु शीर्ष (जुआ)',              visible_to_levels: L, editable_by_levels: E, section: 'incident_details',        sort_order: 13.8, show_when: JSON.stringify({ field: 'act_name', value: 'Gambling Act' }) },
{
  ...
  { id: 'A_7_street',   field_key: 'arrest_street',   field_type: 'TEXT',   applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Street',   label_hi: 'गली / सड़क',  visible_to_levels: L, editable_by_levels: E, section: 'arrest_details', sort_order: 7.1, repeater_entity: 'PERSON_ARRESTED' },
  { id: 'A_7_colony',   field_key: 'arrest_colony',   field_type: 'TEXT',   applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Colony',   label_hi: 'कॉलोनी',    visible_to_levels: L, editable_by_levels: E, section: 'arrest_details', sort_order: 7.2, repeater_entity: 'PERSON_ARRESTED' },
  { id: 'A_7_district', field_key: 'arrest_district', field_type: 'SELECT', applicable_record_types: JSON.stringify(['ARREST']), label_en: 'District', label_hi: 'जिला',       visible_to_levels: L, editable_by_levels: E, section: 'arrest_details', sort_order: 7.3, repeater_entity: 'PERSON_ARRESTED', options: JSON.stringify([{ value: 'New Delhi District (NDD)', label_en: 'New Delhi District (NDD)', label_hi: 'नई दिल्ली जिला' }, { value: 'Central District', label_en: 'Central District', label_hi: 'मध्य जिला' }]) },
  { id: 'A_7_landmark', field_key: 'arrest_landmark', field_type: 'TEXT',   applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Landmark', label_hi: 'लैंडमार्क', visible_to_levels: L, editable_by_levels: E, section: 'arrest_details', sort_order: 7.4, repeater_entity: 'PERSON_ARRESTED' },
