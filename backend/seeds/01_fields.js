...
const fields = [
  ...
  // other_act_name — specify other act name when act_name is Other Act
  { id: 'C_10_other', field_key: 'other_act_name', field_type: 'TEXT', applicable_record_types: JSON.stringify(['CASE', 'ARREST']), label_en: 'Specify Act Name', label_hi: 'अधिनियम का नाम दर्ज करें', visible_to_levels: L, editable_by_levels: E, section: 'incident_details', sort_order: 10.5 },
  ...
  { id: 'C_19', field_key: 'io_mobile', field_type: 'NUMBER', applicable_record_types: JSON.stringify(['CASE', 'ARREST', 'PCR_CALL', 'MISSING', 'UIDB']), label_en: 'IO Mobile No.', label_hi: 'जांच अधिकारी का मोबाइल', visible_to_levels: L, editable_by_levels: E, section: 'investigation_officer', sort_order: 502 },
  ...
  // Physical description fields — shared by MISSING (missing_physical section) and UIDB (corpse_desc section)
  { id: 'MS_16', field_key: 'height', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING', 'UIDB']), label_en: 'Height', label_hi: 'कद', visible_to_levels: L, editable_by_levels: E, section: 'missing_physical', sort_order: 16, is_active: true, scope_level: 'global' },
  { id: 'MS_17', field_key: 'built', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING', 'UIDB']), label_en: 'Built', label_hi: 'शरीर की बनावट', visible_to_levels: L, editable_by_levels: E, section: 'missing_physical', sort_order: 17, is_active: true, scope_level: 'global' },
  { id: 'MS_18', field_key: 'complexion', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING', 'UIDB']), label_en: 'Complexion', label_hi: 'रंग', visible_to_levels: L, editable_by_levels: E, section: 'missing_physical', sort_order: 18, is_active: true, scope_level: 'global' },
  { id: 'MS_20', field_key: 'face', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING', 'UIDB']), label_en: 'Face', label_hi: 'चेहरा', visible_to_levels: L, editable_by_levels: E, section: 'missing_physical', sort_order: 20, is_active: true, scope_level: 'global' },
  { id: 'MS_21', field_key: 'hair', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING', 'UIDB']), label_en: 'Hair', label_hi: 'बाल', visible_to_levels: L, editable_by_levels: E, section: 'missing_physical', sort_order: 21, is_active: true, scope_level: 'global' },
  { id: 'MS_22', field_key: 'moustache', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING', 'UIDB']), label_en: 'Moustache', label_hi: 'मूंछ', visible_to_levels: L, editable_by_levels: E, section: 'missing_physical', sort_order: 22, is_active: true, scope_level: 'global' },
  { id: 'MS_26', field_key: 'beard', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING', 'UIDB']), label_en: 'Beard', label_hi: 'दाढ़ी', visible_to_levels: L, editable_by_levels: E, section: 'missing_physical', sort_order: 23, is_active: true, scope_level: 'global' },
  { id: 'MS_27', field_key: 'upper_dress_color', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING', 'UIDB']), label_en: 'Upper Dress Color', label_hi: 'ऊपरी पोशाक का रंग', visible_to_levels: L, editable_by_levels: E, section: 'missing_physical', sort_order: 19, is_active: true, scope_level: 'global' },
  { id: 'MS_28', field_key: 'lower_dress_color', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING', 'UIDB']), label_en: 'Lower Dress Color', label_hi: 'निचली पोशाक का रंग', visible_to_levels: L, editable_by_levels: E, section: 'missing_physical', sort_order: 20, is_active: true, scope_level: 'global' },
  ...
  { id: 'C_type_info', field_key: 'type_of_information', field_type: 'RADIO', applicable_record_types: JSON.stringify(['CASE']), label_en: 'Type of Information', label_hi: 'सूचना का प्रकार', visible_to_levels: L, editable_by_levels: E, section: 'general_info', sort_order: 1, options: JSON.stringify([{ value: 'Written', label_en: 'Written', label_hi: 'लिखित' }, { value: 'Oral', label_en: 'Oral', label_hi: 'मौखिक' }, { value: 'Court Order', label_en: 'Court Order', label_hi: 'न्यायालय आदेश' }]) },
  { id: 'C_compl_no', field_key: 'complaint_no', field_type: 'TEXT', applicable_record_types: JSON.stringify(['CASE']), label_en: 'Complaint No.', label_hi: 'शिकायत संख्या', visible_to_levels: L, editable_by_levels: E, section: 'general_info', sort_order: 2 },
  { id: 'C_src_ref', field_key: 'source_reference', field_type: 'SELECT', applicable_record_types: JSON.stringify(['CASE']), label_en: 'Source / Reference of Complaint', label_hi: 'शिकायत का स्रोत / संदर्भ', visible_to_levels: L, editable_by_levels: E, section: 'general_info', sort_order: 4, validation_rules: JSON.stringify({ required: true }), options: JSON.stringify([{ value: 'PCR Call', label_en: 'PCR Call', label_hi: 'पीसीआर कॉल' }, { value: 'Written Complaint', label_en: 'Written Complaint', label_hi: 'लिखित शिकायत' }, { value: 'Public Informant', label_en: 'Public Informant', label_hi: 'सार्वजनिक सूचना' }, { value: 'Police Beat Officer', label_en: 'Police Beat Officer', label_hi: 'पुलिस बीट अधिकारी' }, { value: 'Physically appear', label_en: 'Physically appear', label_hi: 'व्यक्तिगत रूप से उपस्थिति' }, { value: 'Court Order', label_en: 'Court Order', label_hi: 'न्यायालय आदेश' }, { value: 'Individual/Group/Agency', label_en: 'Individual/Group/Agency', label_hi: 'व्यक्ति/समूह/एजेंसी' }]) },
  ...
  { id: 'occ_area_type', field_key: 'area_of_crime', field_type: 'RADIO', applicable_record_types: JSON.stringify(['CASE']), label_en: 'Area of Crime', label_hi: 'अपराध क्षेत्र', visible_to_levels: L, editable_by_levels: E, section: 'occurrence_info', sort_order: 4.3, is_active: true, scope_level: 'global', options: JSON.stringify([{ value: 'Rural', label_en: 'Rural', label_hi: 'ग्रामीण' }, { value: 'Urban', label_en: 'Urban', label_hi: 'शहरी' }, { value: 'Semi-Rural', label_en: 'Semi-Rural', label_hi: 'अर्ध-ग्रामीण' }, { value: 'Deserted Area', label_en: 'Deserted Area', label_hi: 'सुनसान क्षेत्र' }, { value: 'Forest', label_en: 'Forest', label_hi: 'वन' }]) },
  ...
  { id: 'C_1', field_key: 'fir_no', field_type: 'TEXT', applicable_record_types: JSON.stringify(['CASE', 'ARREST']), label_en: 'FIR Number,Date & Time', label_hi: 'प्राथमिकी (FIR) संख्या और दिनांक', visible_to_levels: L, editable_by_levels: E, section: 'general_info', sort_order: 1, validation_rules: JSON.stringify({ required: false }) },
  { id: 'C_2', field_key: 'fir_date', field_type: 'DATE', applicable_record_types: JSON.stringify(['CASE', 'ARREST']), label_en: 'FIR Date', label_hi: 'एफआईआर तिथि', visible_to_levels: L, editable_by_levels: E, section: 'general_info', sort_order: 2, validation_rules: JSON.stringify({ required: false }) },
  ...
  { id: 'C_heinous_offence', field_key: 'heinous_offence', field_type: 'RADIO', applicable_record_types: JSON.stringify(['CASE', 'ARREST', 'UIDB']), label_en: 'Heinous Offences', label_hi: 'जघन्य अपराध', visible_to_levels: L, editable_by_levels: E, section: 'incident_details', sort_order: 9.5, validation_rules: JSON.stringify({ required: false }), is_active: true, scope_level: 'global', options: JSON.stringify([{ value: true, label_en: 'Yes', label_hi: 'हाँ' }, { value: false, label_en: 'No', label_hi: 'नहीं' }]) },
  ...
  { id: 'C_13', field_key: 'complainant_name', field_type: 'TEXT', applicable_record_types: JSON.stringify(['CASE', 'ARREST']), label_en: 'Complainant Name', label_hi: 'शिकायतकर्ता का नाम', visible_to_levels: L, editable_by_levels: E, section: 'complainant_accused_info', sort_order: 13, validation_rules: JSON.stringify({ required: false }) },
  ...
  { id: 'C_18', field_key: 'io_pis', field_type: 'TEXT', applicable_record_types: JSON.stringify(['CASE', 'ARREST', 'PCR_CALL', 'MISSING', 'UIDB']), label_en: 'PIS No. of IO', label_hi: 'जांच अधिकारी का पीआईएस नंबर', visible_to_levels: L, editable_by_levels: E, section: 'investigation_officer', sort_order: 506 },
  ...
  { id: 'DD_C9', field_key: 'rc_no', field_type: 'TEXT', applicable_record_types: JSON.stringify(['CASE']), label_en: 'RC No.', label_hi: 'आरसी संख्या', visible_to_levels: L, editable_by_levels: E, section: 'investigation_details', sort_order: 505, is_active: true, scope_level: 'global' },
  { id: 'DD_C10', field_key: 'disposal_type', field_type: 'SELECT', applicable_record_types: JSON.stringify(['CASE']), label_en: 'Disposal Type', label_hi: 'निपटान प्रकार', visible_to_levels: L, editable_by_levels: E, section: 'investigation_details', sort_order: 504, is_active: true, scope_level: 'global', options: JSON.stringify([{ value: 'Challan', label_en: 'Challan', label_hi: 'चालान' }, { value: 'Untrace', label_en: 'Untraced', label_hi: 'अपता' }, { value: 'Cancel', label_en: 'Cancelled', label_hi: 'रद्द' }]) },
  { id: 'C_case_status', field_key: 'case_status', field_type: 'SELECT', applicable_record_types: JSON.stringify(['CASE']), label_en: 'Status', label_hi: 'स्थिति', visible_to_levels: L, editable_by_levels: E, section: 'investigation_officer', sort_order: 503, is_active: true, scope_level: 'global', options: JSON.stringify([{ value: 'CHARGE SHEET', label_en: 'CHARGE SHEET', label_hi: 'आरोप पत्र' }, { value: 'POLICE INVESTIGATION REPORT(PIR-JCL)', label_en: 'POLICE INVESTIGATION REPORT(PIR-JCL)', label_hi: 'पुलिस जांच रिपोर्ट (PIR-JCL)' }, { value: 'UNTRACED', label_en: 'UNTRACED', label_hi: 'अनट्रेस्ड' }, { value: 'PENDING', label_en: 'PENDING', label_hi: 'लंबित' }, { value: 'CANCELLATION', label_en: 'CANCELLATION', label_hi: 'रद्दीकरण' }, { value: 'QUASHED', label_en: 'QUASHED', label_hi: 'रद्द / क्वैश' }, { value: 'CLOSURE REPORT', label_en: 'CLOSURE REPORT', label_hi: 'क्लोजर रिपोर्ट' }, { value: 'RELEASED U/S 189 BNSS', label_en: 'RELEASED U/S 189 BNSS', label_hi: 'धारा 189 बीएनएसएस के तहत रिहा' }, { value: 'TRANSFER', label_en: 'TRANSFER', label_hi: 'स्थानांतरण' }]) },
  { id: 'C_transfer_to', field_key: 'transfer_to', field_type: 'RADIO', applicable_record_types: JSON.stringify(['CASE']), label_en: 'Transfer To', label_hi: 'स्थानांतरण करें', visible_to_levels: L, editable_by_levels: E, section: 'investigation_officer', sort_order: 507, is_active: false, scope_level: 'global', show_when: JSON.stringify({ field: 'case_status', value: 'TRANSFER' }), options: JSON.stringify([{ value: 'PS', label_en: 'PS', label_hi: 'पुलिस स्टेशन' }, { value: 'Agency', label_en: 'Agency', label_hi: 'एजेंसी' }]) },
  ...
  { id: 'A_6',  field_key: 'arrest_date',                 field_type: 'DATE',     applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Date & Time of Arrest',                   label_hi: 'गिरफ्तारी की तिथि',                    visible_to_levels: L, editable_by_levels: E, section: 'arrest_details',  sort_order: 6, validation_rules: JSON.stringify({ required: false }), repeater_entity: 'PERSON_ARRESTED' },
  { id: 'A_7',  field_key: 'arrest_place',                field_type: 'TEXT',     applicable_record_types: JSON.stringify(['ARREST']), label_en: 'House No. of Arrest',             label_hi: 'गिरफ्तारी का मकान संख्या',              visible_to_levels: L, editable_by_levels: E, section: 'arrest_details',  sort_order: 7, repeater_entity: 'PERSON_ARRESTED' },
  { id: 'A_7_street',   field_key: 'arrest_street',   field_type: 'TEXT',   applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Street of Arrest',     label_hi: 'गिरफ्तारी का गली / सड़क',   visible_to_levels: L, editable_by_levels: E, section: 'arrest_details', sort_order: 7.1, repeater_entity: 'PERSON_ARRESTED' },
  { id: 'A_7_colony',   field_key: 'arrest_colony',   field_type: 'TEXT',   applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Colony of Arrest',     label_hi: 'गिरफ्तारी का कॉलोनी',      visible_to_levels: L, editable_by_levels: E, section: 'arrest_details', sort_order: 7.2, repeater_entity: 'PERSON_ARRESTED' },
  { id: 'A_7_district', field_key: 'arrest_district', field_type: 'SELECT', applicable_record_types: JSON.stringify(['ARREST']), label_en: 'District of Arrest',   label_hi: 'गिरफ्तारी का जिला',         visible_to_levels: L, editable_by_levels: E, section: 'arrest_details', sort_order: 7.3, repeater_entity: 'PERSON_ARRESTED', options: DISTRICT_OPTS },
  { id: 'A_7_landmark', field_key: 'arrest_landmark', field_type: 'TEXT',   applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Landmark of Arrest',   label_hi: 'गिरफ्तारी का लैंडमार्क',    visible_to_levels: L, editable_by_levels: E, section: 'arrest_details', sort_order: 7.4, repeater_entity: 'PERSON_ARRESTED' },
  ...
  { id: 'A_32', field_key: 'scheme_of_arrest',            field_type: 'SELECT',   applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Scheme of Arrest',                  label_hi: 'गिरफ्तारी की योजना',                  visible_to_levels: L, editable_by_levels: E, section: 'arrested_personal_info', sort_order: 10.5, validation_rules: JSON.stringify({ required: false }), repeater_entity: 'PERSON_ARRESTED', options: JSON.stringify([
  ...
  { id: 'A_12', field_key: 'nafis_prepared',              field_type: 'RADIO',  applicable_record_types: JSON.stringify(['ARREST']), label_en: 'NAFIS Prepared',                   label_hi: 'नाफिस तैयार किया गया',                 visible_to_levels: L, editable_by_levels: E, section: 'arrestee_info', sort_order: 12, show_when: JSON.stringify({ required: false }), is_active: true, scope_level: 'global', repeater_entity: 'PERSON_ARRESTED', options: JSON.stringify([{ value: 'Yes', label_en: 'Yes', label_hi: 'हाँ' }, { value: 'No', label_en: 'No', label_hi: 'नहीं' }]) },
  { id: 'A_13', field_key: 'dossier_prepared',            field_type: 'RADIO',  applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Dossier Prepared',                 label_hi: 'डोजियर तैयार किया गया',                visible_to_levels: L, editable_by_levels: E, section: 'arrestee_info', sort_order: 13, show_when: JSON.stringify({ required: false }), is_active: true, scope_level: 'global', repeater_entity: 'PERSON_ARRESTED', options: JSON.stringify([{ value: 'Yes', label_en: 'Yes', label_hi: 'हाँ' }, { value: 'No', label_en: 'No', label_hi: 'नहीं' }]) },
  ...
  { id: 'A_15', field_key: 'nick_name',                   field_type: 'TEXT',     applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Nick Name',                        label_hi: 'उपनाम',                                visible_to_levels: L, editable_by_levels: E, section: 'arrested_personal_info', sort_order: 403.5, is_active: true, scope_level: 'global', repeater_entity: 'PERSON_ARRESTED' },
  ...
  { id: 'A_17', field_key: 'prev_involvement',            field_type: 'RADIO',   applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Prev. Involvement (Y/N)',           label_hi: 'पूर्व संलिप्तता (हाँ/नहीं)',           visible_to_levels: L, editable_by_levels: E, section: 'arrestee_info', sort_order: 17, is_active: true, scope_level: 'global', repeater_entity: 'PERSON_ARRESTED', options: JSON.stringify([{ value: 'Yes', label_en: 'Yes', label_hi: 'हाँ' }, { value: 'No', label_en: 'No', label_hi: 'नहीं' }]) },
  ...
  { id: 'A_27', field_key: 'arresting_officer_mobile',    field_type: 'TEXT',     applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Contact of Arresting Officer',     label_hi: 'गिरफ्तार करने वाले अधिकारी का मोबाइल', visible_to_levels: L, editable_by_levels: E, section: 'arrestee_info', sort_order: 21, is_active: true, scope_level: 'global', repeater_entity: 'PERSON_ARRESTED' },
  ...
  { id: 'A_30', field_key: 'arresting_officer',           field_type: 'TEXT',     applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Arresting Officer',                label_hi: 'गिरफ्तार करने वाले अधिकारी',           visible_to_levels: L, editable_by_levels: E, section: 'arrestee_info', sort_order: 20, is_active: true, scope_level: 'global', repeater_entity: 'PERSON_ARRESTED' },
  ...
  //{ id: 'DD_A2',  field_key: 'bad_character',               field_type: 'RADIO', applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Is Bad Character (BC)',                   label_hi: 'बदमाश (बीसी) है या नहीं',               visible_to_levels: L, editable_by_levels: E, section: 'arrestee_info', sort_order: 20, is_active: true, scope_level: 'global', repeater_entity: 'PERSON_ARRESTED', options: JSON.stringify([{ value: 'Yes', label_en: 'Yes', label_hi: 'हाँ' }, { value: 'No', label_en: 'No', label_hi: 'नहीं' }]) },
  { id: 'DD_A3',  field_key: 'proclaimed_offender',         field_type: 'RADIO',applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Proclaimed Offender (PO)',                label_hi: 'घोषित अपराधी (पीओ)',                    visible_to_levels: L, editable_by_levels: E, section: 'arrestee_info', sort_order: 18, is_active: true, scope_level: 'global', repeater_entity: 'PERSON_ARRESTED', options: JSON.stringify([{ value: 'Yes', label_en: 'Yes', label_hi: 'हाँ' }, { value: 'No', label_en: 'No', label_hi: 'नहीं' }]) },
  { id: 'DD_A4', field_key: 'listed_criminal', field_type: 'RADIO',
    ...
    section: 'arrestee_info', sort_order: 19, repeater_entity: 'PERSON_ARRESTED',
  ...
  // Arms & Ammunition extra detail fields (Property of Interest panel) — options are NOT
  // static JSON; the frontend fetches them live from excel_fire_arms/excel_arms_made via
  // /fields/lookup/property-items/:parent_cd (same call already used for Type of Property).
  { id: 'PROP_5', field_key: 'prop_fire_arms_type', field_type: 'SELECT', repeater_entity: 'PROPERTY', applicable_record_types: JSON.stringify(['CASE', 'ARREST']), label_en: 'Type of Arm', label_hi: 'हथियार का प्रकार', visible_to_levels: L, editable_by_levels: E, section: 'property_details', sort_order: 334, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'property_major_category', value: 'Arms' }) },
  { id: 'PROP_6', field_key: 'prop_arms_made', field_type: 'SELECT', repeater_entity: 'PROPERTY', applicable_record_types: JSON.stringify(['CASE', 'ARREST']), label_en: 'Subtype of Arm', label_hi: 'हथियार का उपप्रकार', visible_to_levels: L, editable_by_levels: E, section: 'property_details', sort_order: 335, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'property_major_category', value: 'Arms' }) },
  // NOTE: Vehicle extra-detail fields (registration no. / CD-uploaded / CCTV) are NOT
  // redefined here — migration 20260629200000_prop_vehicle_repeater_fields.js already
  // owns prop_vehicle_no / prop_cd_24h / prop_cctv for this exact purpose. Adding
  // duplicate field_keys here caused them to render twice in the detail panel.
  // "Others" extra detail field — cascades off "Type of Property" (excel_other_property_categories,
  // e.g. Agriculture Products/Animals), listing excel_other_property_items filtered by that
  // category's parent_cd. Options come from the live lookup fetch, not field.options.
  { id: 'PROP_11', field_key: 'prop_other_subtype', field_type: 'SELECT', repeater_entity: 'PROPERTY', applicable_record_types: JSON.stringify(['CASE', 'ARREST']), label_en: 'Property Subtype', label_hi: 'संपत्ति उपप्रकार', visible_to_levels: L, editable_by_levels: E, section: 'property_details', sort_order: 340, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'property_major_category', value: 'OTHERS' }) },
  // ─────────────────────────────────────────────────────────────────────────────
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // mp_known is auto-set by missing_type in the frontend — hidden from UI but used for show_when logic
  { id: 'MS_mp_known', field_key: 'mp_known', field_type: 'RADIO', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Is Missing Person Identified / Known?', label_hi: 'क्या लापता व्यक्ति की पहचान ज्ञात है?', visible_to_levels: L, editable_by_levels: E, section: 'person_details', sort_order: 2.0, is_active: false, scope_level: 'global', validation_rules: JSON.stringify({ required: true }), options: JSON.stringify([{ value: true, label_en: 'Yes', label_hi: 'हाँ' }, { value: false, label_en: 'No', label_hi: 'नहीं' }]) },
  ...
  // Present Address — now in missing_address section
  { id: 'MS_mp_house_no', field_key: 'mp_house_no', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Present House No.', label_hi: 'वर्तमान मकान संख्या', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.10, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'mp_known', value: true }) },
  { id: 'MS_mp_street', field_key: 'mp_street', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Present Street', label_hi: 'वर्तमान गली / सड़क', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.11, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'mp_known', value: true }) },
  { id: 'MS_mp_colony', field_key: 'mp_colony', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Present Colony', label_hi: 'वर्तमान कॉलोनी', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.12, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'mp_known', value: true }) },
  { id: 'MS_mp_city_town_village', field_key: 'mp_city_town_village', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Present Village / City / Town', label_hi: 'वर्तमान गांव / शहर / नगर', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.13, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'mp_known', value: true }) },
  { id: 'MS_mp_state', field_key: 'mp_state', field_type: 'SELECT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Present State', label_hi: 'वर्तमान राज्य', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.14, is_active: true, scope_level: 'global', options: STATE_OPTS, show_when: JSON.stringify({ field: 'mp_known', value: true }) },
  { id: 'MS_mp_district', field_key: 'mp_district', field_type: 'SELECT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Present District', label_hi: 'वर्तमान जिला', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.15, is_active: true, scope_level: 'global', options: DISTRICT_OPTS, show_when: JSON.stringify({ field: 'mp_known', value: true }) },
  { id: 'MS_mp_pincode', field_key: 'mp_pincode', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Present Pin Code', label_hi: 'वर्तमान पिन कोड', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.16, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'mp_known', value: true }) },
  { id: 'MS_15', field_key: 'mp_address', field_type: 'TEXTAREA', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Present Full Address', label_hi: 'लापता व्यक्ति का वर्तमान पता (विस्तृत)', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.18, is_active: true, scope_level: 'global', full_width: true, show_when: JSON.stringify({ field: 'mp_known', value: true }) },

  // Permanent Address toggle — in missing_address section
  { id: 'mp_perm_same', field_key: 'mp_perm_same', field_type: 'SELECT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Is Permanent Address same as Present Address?', label_hi: 'क्या स्थायी पता वर्तमान पते के समान है?', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.20, options: JSON.stringify([{ value: 'Yes', label_en: 'Yes', label_hi: 'हां' }, { value: 'No', label_en: 'No', label_hi: 'नहीं' }]), show_when: JSON.stringify({ field: 'mp_known', value: true }), validation_rules: JSON.stringify({ required: true }) },

  // Permanent Address fields — in missing_address section
  { id: 'MS_mp_perm_house_no', field_key: 'mp_perm_house_no', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Permanent House No.', label_hi: 'स्थायी मकान संख्या', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.21, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'mp_perm_same', value: 'No' }) },
  { id: 'MS_mp_perm_street', field_key: 'mp_perm_street', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Permanent Street', label_hi: 'स्थायी गली / सड़क', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.22, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'mp_perm_same', value: 'No' }) },
  { id: 'MS_mp_perm_colony', field_key: 'mp_perm_colony', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Permanent Colony', label_hi: 'स्थायी कॉलोनी', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.23, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'mp_perm_same', value: 'No' }) },
  { id: 'MS_mp_perm_city_town_village', field_key: 'mp_perm_city_town_village', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Permanent Village / City / Town', label_hi: 'स्थायी गांव / शहर / नगर', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.24, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'mp_perm_same', value: 'No' }) },
  { id: 'MS_mp_perm_state', field_key: 'mp_perm_state', field_type: 'SELECT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Permanent State', label_hi: 'स्थायी राज्य', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.25, is_active: true, scope_level: 'global', options: STATE_OPTS, show_when: JSON.stringify({ field: 'mp_perm_same', value: 'No' }) },
  { id: 'MS_mp_perm_district', field_key: 'mp_perm_district', field_type: 'SELECT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Permanent District', label_hi: 'स्थायी जिला', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.26, is_active: true, scope_level: 'global', options: DISTRICT_OPTS, show_when: JSON.stringify({ field: 'mp_perm_same', value: 'No' }) },
  { id: 'MS_mp_perm_pincode', field_key: 'mp_perm_pincode', field_type: 'TEXT', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Permanent Pin Code', label_hi: 'स्थायी पिन कोड', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.27, is_active: true, scope_level: 'global', show_when: JSON.stringify({ field: 'mp_perm_same', value: 'No' }) },
  { id: 'DD_M1', field_key: 'missing_address', field_type: 'TEXTAREA', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Full Permanent Address', label_hi: 'लापता व्यक्ति का स्थायी पता (विस्तृत)', visible_to_levels: L, editable_by_levels: E, section: 'missing_address', sort_order: 2.29, is_active: true, scope_level: 'global', full_width: true, show_when: JSON.stringify({ field: 'mp_perm_same', value: 'No' }) },
  ...
  { id: 'MS_19', field_key: 'Mental State', field_type: 'RADIO', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Mental State', label_hi: 'मानसिक स्थिति', visible_to_levels: L, editable_by_levels: E, section: 'person_details', sort_order: 2.45, is_active: true, scope_level: 'global', options: JSON.stringify([{ value: 'Normal', label_en: 'Normal', label_hi: 'सामान्य' }, { value: 'Abnormal', label_en: 'Abnormal', label_hi: 'असामान्य' }]) },

  // Physical Description fields — now in missing_physical section
  { id: 'MS_9', field_key: 'physical_description', field_type: 'TEXTAREA', applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Physical Description', label_hi: 'शारीरिक हुलिया', visible_to_levels: L, editable_by_levels: E, section: 'missing_physical', sort_order: 2.46, full_width: true },
  { id: 'MS_23',field_key: 'missing_type',                 field_type: 'RADIO',   applicable_record_types: JSON.stringify(['MISSING']), label_en: 'Missing / Found Type',   label_hi: 'लापता / मिला प्रकार',          visible_to_levels: L, editable_by_levels: E, section: 'general_info',         sort_order: 3,  is_active: true, scope_level: 'global', options: JSON.stringify([{ value: 'Missing', label_en: 'Missing', label_hi: 'लापता' }, { value: 'Found', label_en: 'Found', label_hi: 'मिला' }]) },
 // { id: 'MS_24',field_key: 'pcr_call_flag',                field_type: 'RADIO',  applicable_record_types: JSON.stringify(['MISSING']), label_en: 'PCR Call (Y/N)',         label_hi: 'पीसीआर कॉल (हाँ/नहीं)',         visible_to_levels: L, editable_by_levels: E, section: 'general_info',         sort_order: 4,  is_active: true, scope_level: 'global', options: JSON.stringify([{ value: true, label_en: 'Yes', label_hi: 'हाँ' }, { value: false, label_en: 'No', label_hi: 'नहीं' }]) },
  ...
  { id: 'U_6', field_key: 'description', field_type: 'TEXTAREA', applicable_record_types: JSON.stringify(['UIDB']), label_en: 'Physical Description', label_hi: 'शारीरिक हुलिया', visible_to_levels: L, editable_by_levels: E, section: 'corpse_physical', sort_order: 6, full_width: true },
...
function generateAddressFields(prefix, labelPrefixEn, labelPrefixHi, recordTypes, sectionOverride = null) {
  ...
  return [
    ...
    {
      id: prefix === 'occurrence' ? 'occurrence_landmark' : `${prefix}_state`,
      field_key: prefix === 'occurrence' ? 'occurrence_landmark' : `${prefix}_state`,
      field_type: prefix === 'occurrence' ? 'TEXT' : 'SELECT',
      applicable_record_types: prefix === 'occurrence' ? JSON.stringify(['CASE', 'PCR_CALL']) : typesStr,
      label_en: prefix === 'occurrence' ? `${labelPrefixEn} Landmark` : `${labelPrefixEn} State`,
      label_hi: prefix === 'occurrence' ? `${labelPrefixHi} लैंडमार्क` : `${labelPrefixHi} राज्य`,
      visible_to_levels: L,
      editable_by_levels: E,
      section: targetSection,
      sort_order: 3.7,
      is_active: true,
      scope_level: 'global',
      ...(prefix !== 'occurrence' ? { options: STATE_OPTS } : {})
    },
    {
      id: `${prefix}_district`,
...
const generatedFields = [
  ...generatePersonFields('complainant', 'Complainant', 'शिकायतकर्ता', ['CASE'], null, 400),
...
export async function seed(knex) {
  ...
  // NOTE: this file intentionally does NOT delete rows missing from its own array.
  // field_registry also has rows managed by migrations (e.g. 20260629500000_property_
  // category_fields.js, 20260701000000_restore_all_conditional_property_fields.js) —
  // a prior version of this seed did a `whereNotIn(field_key, keys).del()` "cleanup"
  // that silently wiped all of those every time this seed re-ran, which is exactly why
  // 20260701000000_restore_all_conditional_property_fields.js had to exist. Upsert-only,
  // matching the safe pattern documented in 03_config.js / 04_users.js.
