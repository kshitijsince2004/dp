...
const fields = [
  ...
  { id: 'MS_13',field_key: 'zipnet_no',         field_type: 'TEXT',   applicable_record_types: JSON.stringify(['UIDB']),                              label_en: 'ZIPNET No.',                  label_hi: 'जिपनेट संख्या',                 visible_to_levels: L, editable_by_levels: E, section: 'contacts_assigned',       sort_order: 13 },
  ...
  { id: 'C_min_gamb',  field_key: 'gambling_minor_head',  field_type: 'TEXT',     applicable_record_types: JSON.stringify(['CASE', 'ARREST','UIDB']), label_en: 'Minor Head (Gambling)',               label_hi: 'लघु शीर्ष (जुआ)',              visible_to_levels: L, editable_by_levels: E, section: 'incident_details',        sort_order: 13.8, show_when: JSON.stringify({ field: 'act_name', value: 'Gambling Act' }) },
{
  ...
  { id: 'A_7',  field_key: 'arrest_place',                field_type: 'TEXT',     applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Place of Arrest',                  label_hi: 'गिरफ्तारी का स्थान',                   visible_to_levels: L, editable_by_levels: E, section: 'arrest_details',  sort_order: 7, repeater_entity: 'PERSON_ARRESTED' },
...
<<<<<<< HEAD
  { id: 'A_12', field_key: 'nafis_prepared',              field_type: 'SELECT', applicable_record_types: JSON.stringify(['ARREST']), label_en: 'NAFIS Prepared',                   label_hi: 'नाफिस तैयार किया गया',                 visible_to_levels: L, editable_by_levels: E, section: 'arrestee_info', sort_order: 12, show_when: JSON.stringify({ required: false }), is_active: true, scope_level: 'global', repeater_entity: 'PERSON_ARRESTED', options: JSON.stringify([{ value: 'Yes', label_en: 'Yes', label_hi: 'हाँ' }, { value: 'No', label_en: 'No', label_hi: 'नहीं' }]) },
  { id: 'A_13', field_key: 'dossier_prepared',            field_type: 'SELECT', applicable_record_types: JSON.stringify(['ARREST']), label_en: 'Dossier Prepared',                 label_hi: 'डोजियर तैयार किया गया',                visible_to_levels: L, editable_by_levels: E, section: 'arrestee_info', sort_order: 13, show_when: JSON.stringify({ required: false }), is_active: true, scope_level: 'global', repeater_entity: 'PERSON_ARRESTED', options: JSON.stringify([{ value: 'Yes', label_en: 'Yes', label_hi: 'हाँ' }, { value: 'No', label_en: 'No', label_hi: 'नहीं' }]) },
=======
...
>>>>>>> 96e1851d5a7557efca1c7127f98d0c242b8b7e6a
